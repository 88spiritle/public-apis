...
* <!-- personal note: before opening a PR, I find it helpful to preview the markdown table rendering locally using `grip` (pip install grip) to catch alignment issues before they show up in review. -->